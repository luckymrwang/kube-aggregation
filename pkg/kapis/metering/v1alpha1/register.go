...
import (
	...
	model "kube-aggregation/pkg/models/monitoring"
	resourcev1alpha3 "kube-aggregation/pkg/models/resources/v1alpha3/resource"
	meteringclient "kube-aggregation/pkg/simple/client/metering"
...
func AddToContainer(c *restful.Container, k8sClient kubernetes.Interface, meteringClient monitoring.Interface, factory informers.InformerFactory, cache cache.Cache, meteringOptions *meteringclient.Options, rtClient runtimeclient.Client) error {
	ws := runtime.NewWebService(GroupVersion)

	h := newHandler(k8sClient, meteringClient, factory, resourcev1alpha3.NewResourceGetter(factory, cache), meteringOptions, rtClient)
