...
import (
	...
	clusterv1alpha1 "kube-aggregation/pkg/api/cluster/v1alpha1"
	"kube-aggregation/pkg/apiserver/config"
	kubesphere "kube-aggregation/pkg/client/clientset/versioned"
	"kube-aggregation/pkg/client/informers/externalversions"
	clusterlister "kube-aggregation/pkg/client/listers/cluster/v1alpha1"
