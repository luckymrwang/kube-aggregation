...
import (
	...
	"kube-aggregation/pkg/simple/client/es/query"
	"kube-aggregation/pkg/simple/client/es/versions"
	v5 "kube-aggregation/pkg/simple/client/es/versions/v5"
	v6 "kube-aggregation/pkg/simple/client/es/versions/v6"
	v7 "kube-aggregation/pkg/simple/client/es/versions/v7"
	"kube-aggregation/pkg/utils/esutil"
)
