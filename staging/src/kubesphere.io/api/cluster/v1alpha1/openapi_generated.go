			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"kubesphereAPIEndpoint": {
						SchemaProps: spec.SchemaProps{
							Description: "KubeAggregation API Server endpoint. Example: http://10.10.0.11:8080 Should provide this field explicitly if connection type is direct. Will be populated by ks-apiserver if connection type is proxy.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
