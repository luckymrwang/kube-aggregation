...
import (
	...
	"kube-aggregation/cmd/controller-manager/app/options"
	"kube-aggregation/pkg/controller/application"
	"kube-aggregation/pkg/controller/helm"
	"kube-aggregation/pkg/controller/namespace"
	"kube-aggregation/pkg/controller/openpitrix/helmapplication"
	"kube-aggregation/pkg/controller/openpitrix/helmcategory"
	"kube-aggregation/pkg/controller/openpitrix/helmrelease"
	"kube-aggregation/pkg/controller/openpitrix/helmrepo"
	"kube-aggregation/pkg/controller/quota"
	"kube-aggregation/pkg/controller/serviceaccount"
	"kube-aggregation/pkg/controller/user"
	"kube-aggregation/pkg/controller/workspace"
	"kube-aggregation/pkg/controller/workspacerole"
	"kube-aggregation/pkg/controller/workspacerolebinding"
	"kube-aggregation/pkg/controller/workspacetemplate"
	"kube-aggregation/pkg/models/kubeconfig"
	"kube-aggregation/pkg/simple/client/devops"
	"kube-aggregation/pkg/simple/client/devops/jenkins"
	ldapclient "kube-aggregation/pkg/simple/client/ldap"
	"kube-aggregation/pkg/simple/client/s3"

	"kube-aggregation/pkg/controller/storage/snapshotclass"

	iamv1alpha2 "kubesphere.io/api/iam/v1alpha2"

	"kube-aggregation/pkg/controller/certificatesigningrequest"
	"kube-aggregation/pkg/controller/cluster"
	"kube-aggregation/pkg/controller/clusterrolebinding"
	"kube-aggregation/pkg/controller/destinationrule"
	"kube-aggregation/pkg/controller/globalrole"
	"kube-aggregation/pkg/controller/globalrolebinding"
	"kube-aggregation/pkg/controller/group"
	"kube-aggregation/pkg/controller/groupbinding"
	"kube-aggregation/pkg/controller/job"
	"kube-aggregation/pkg/controller/loginrecord"
	"kube-aggregation/pkg/controller/network/ippool"
	"kube-aggregation/pkg/controller/network/nsnetworkpolicy"
	"kube-aggregation/pkg/controller/network/nsnetworkpolicy/provider"
	"kube-aggregation/pkg/controller/notification"
	"kube-aggregation/pkg/controller/storage/capability"
	"kube-aggregation/pkg/controller/virtualservice"
	"kube-aggregation/pkg/informers"
	"kube-aggregation/pkg/simple/client/k8s"
	ippoolclient "kube-aggregation/pkg/simple/client/network/ippool"
)
